...
import { ZoomIn, ZoomOut, Move, Power, Calculator, Zap } from "lucide-react";
...
export default function Toolbar() {
  ...
  return (
    <TooltipProvider>
      <div className="p-2 bg-gray-100 flex flex-wrap gap-2 items-center justify-center md:justify-start">
        <Toggle
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button size="icon" variant="outline" aria-label="Calculate power">
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button size="icon" variant="outline" aria-label="Calculate energy">
